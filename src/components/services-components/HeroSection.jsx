...
const HeroSection = ({ serviceContent }) => {
    return (
        <section
            ...
            style={{ backgroundImage: `url(${Images[serviceContent.serviceImage]})` }}
        >
            ...
            <div className="relative z-10 container mx-auto flex flex-col items-start justify-center h-full pl-4 md:pl-16 px-4 md:px-0">
                <h1 className="text-white text-3xl md:text-6xl font-extrabold mb-4 md:mb-8 font-poppins">{serviceContent.serviceName}</h1>
                <p className="text-white text-lg md:text-4xl mb-6 md:mb-10 max-w-xs md:max-w-xl font-outfit">
                    {serviceContent.serviceDescription}
                </p>
                <Button
                    color="orange"
