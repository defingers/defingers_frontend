...
import groupImage from "../../assets/team_members/groupphoto.png"
const StoryAchievementSection = () => {
  ...
  <div className="relative" style={{ backgroundColor: '#FDEDAF' }}>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 ">
        ...
        {/* Image Section */}
        <div className="image-section-responsive w-full mx-auto mt-8 relative z-10">
          <div className="rounded-2xl overflow-hidden shadow-2xl bg-gray-100 mx-4">
            <img 
              src={groupImage}
              alt="Team meeting in conference room"
              className="w-full h-auto max-h-96 sm:max-h-[500px] md:max-h-[600px] lg:max-h-[700px] object-cover mx-auto"
              onError={(e) => {
