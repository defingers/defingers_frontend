      ...
      <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
        ...
        <div className="flex-1">
          ...
          <p className="text-gray-600 text-base sm:text-lg max-w-2xl leading-relaxed text-left">
            Start a conversation with our team and discover how our IT and cloud expertise can help your business grow. Follow us to stay connected with our journey and innovations.
          </p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 w-full lg:w-auto">
          ...
          <button 
            className="bg-gray-200 hover:bg-gray-300 text-gray-800 px-6 py-3 rounded-lg font-semibold text-center transition-colors duration-200 whitespace-nowrap"
            onClick={() => {
